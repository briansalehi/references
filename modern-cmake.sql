...
call flashback.create_note_with_name('Modern CMake for C++', 3, 'What are the side effects of assigning the minimum required version to a cmake listfile?');
...
call flashback.create_note_with_name('Modern CMake for C++', 3, 'Define project details in CMake listfile?');
...
call flashback.create_note_with_name('Modern CMake for C++', 3, 'What languages are supported by CMake?');
...
');
call flashback.create_note_with_name('Modern CMake for C++', 3, 'What variables provide the version information about the project?');


call flashback.add_block('text', 'txt'  , '- `PROJECT_DESCRIPTION`, `<project-name>_DESCRIPTION`
- `PROJECT_HOMEPAGE_URL`, `<project-name>_HOMEPAGE_URL`');
call flashback.create_note_with_name('Modern CMake for C++', 3, 'What variables provide project information?');
...
call flashback.create_note_with_name('Modern CMake for C++', 3, 'Include another CMake listfile?');
...
call flashback.create_note_with_name('Modern CMake for C++', 3, 'What are the disadvantages of including another listfile?');
...
call flashback.create_note_with_name('Modern CMake for C++', 3, 'Include another CMake listfile with a scope?');
...
call flashback.add_block('code', 'sh'   , '');
call flashback.add_block('text', 'txt'  , '');
call flashback.create_note_with_name('Modern CMake for C++', 3, '');
...
call set_section_as_complete('Modern CMake for C++', 3);
