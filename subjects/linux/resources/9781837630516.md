...
> **Description**
>
> Download and install VirtualBox and the VirtualBox Extension Pack from https://www.virtualbox.org - https://www.virtualbox.org/.
>
...
>
> ```sh
> vbox_sum256="$(wget -O - -q "https://www.virtualbox.org - https://www.virtualbox.org/download/hashes/${vbox_version}/SHA256SUMS" | grep "${vbox_version}.vbox-extpack" | cut -d' ' -f1)"
...
> ``````
>
> Download the installation `.iso` files for Ubuntu Server 22.04, CentOS 7, AlmaLinux8, and AlmaLinux9 from https://ubuntu.com - https://ubuntu.com/, https://almalinux.org/, and https://www.centos.org/.
>
...
> **Description**
>
> Spend some time perusing the Common Vulnerabilities and Exposures database on https://cve.mitre.org - https://cve.mitre.org/ and you’ll soon see why it’s so important to keep your systems updated.
>
> ---
> **Resources**
> - 1
...
> ---
> **References**
> - https://opensource.com - https://opensource.com/article/22/2/new-sudo-features-2022
> ---
</details>
...
> curl https://api.pwnedpasswords.com - https://api.pwnedpasswords.com/range/21BD1
> ``````
>
> ---
> **Resources**
