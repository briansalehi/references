...
<details>
<summary>Except for binary operations like `and` and `or`, how can we set or reset bits of numeric variables?</summary>
...
<details>
<summary>Having a quad-word variable of numeric type, except for `or` instruction, how can we check if its 8th bit is set?</summary>
