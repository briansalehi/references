...
<details>
<summary>Create a default constructed, copy constructed, and move constructed `std::pair<>`:</summary>
...
<details>
<summary>Use piecewise construction of `std::pair<T1, T2>(std::piecewise_construct, t1, t2)` to initialize values by the elements of tuples `t1` and `t2`:</summary>
