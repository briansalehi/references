...
Jump back from definition using the tag history:
...
Specify jump to multi-match definitions:

* (`tags-and-searches`)::(`:tag-matchlist`)::(`g_ctrl-]`)

Select tag from matchlist after jumping to a wrong definition:
