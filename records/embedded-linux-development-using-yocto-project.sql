...
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 1', 'What is Poky?');
...
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 1', 'What is the usage of bitbake?');
...
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 1', 'How does bitbake operate?');
...
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 1', 'What is OpenEmbedded Core?');
...
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 1', 'What is a metadata made of?');

call flashback.add_block('git clone https://git.yoctoproject.org/git/poky.git --branch kirkstone', 'code', 'sh');
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 2', 'Get poky source tree?');

call flashback.add_block('source oe-init-buid-env [build-directory=build]', 'code', 'sh');
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 2', 'Prepare the poky build environment?');

call flashback.add_block('', 'text', 'txt');
call flashback.add_block('', 'code', 'sql');
call flashback.add_block('', 'text', 'txt');
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 2', 'What does the <code>conf/local.conf</code> contain?');

call flashback.add_block('', 'text', 'txt');
call flashback.add_block('', 'code', 'sql');
call flashback.add_block('', 'text', 'txt');
call flashback.create_note_with_name('Embedded Linux Development Using Yocto Project', 'Chapter 2', '');
