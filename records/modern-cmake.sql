...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'How many execution modes exist in CMake?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What case sensitivity does CMake follow for writing commands?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'How many variable categories exist in CMake?');

call flashback.add_block('Variable names are case-sensitive and can include almost any character.', 'text', 'txt');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What sensitivity do CMake variables follow?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the default type of variables in CMake?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What are the basic variable manipulation commands in CMake?');
...
call flashback.add_block('set([[source files]] "main.cpp")', 'code', 'cmake');
call flashback.add_block('set("source files" "main.cpp")', 'code', 'cmake');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'Create a normal CMake variable?');

call flashback.add_block('unset(source-files)', 'code', 'cmake');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'Remove a normal CMake variable?');

call flashback.add_block('${variable}', 'code', 'cmake');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the syntax of referencing a CMake variable?');

call flashback.add_block('$ENV{variable}', 'code', 'cmake');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the syntax of referencing a CMake environment variable?');

call flashback.add_block('$CACHE{variable}', 'code', 'cmake');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the syntax of referencing a CMake cache variable?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'How does CMake traverse scopes to reference a variable?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What variable will be changed when assigning a value to a variable reference instead of a variable name in CMake listfile?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the precedence of CMake variable evaluation in different variable categories?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What normal variables are defined as arguments passed to CMake?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What are the CMake environment variables coming from?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the lifetime of CMake environment variables?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the lifetime of CMake cache variables?');

call flashback.add_block('set(<variable> <value> CACHE <type> <description> [FORCE])', 'code', 'cmake');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'Define a CMake cache variable?');
...
- `STRING`
- INTERNAL`', 'text', 'list');
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What variable types exist for CMake cache variables?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'How many scopes exist in CMake?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'What is the difference between inner and outer CMake scopes?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'Which CMake commands create file scopes?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'Create a new block in a CMake listfile?');
...
call flashback.create_note_with_name('CMake', 'Chapter 2', 'Propagate a variable in a block to the outer scope in a CMake listfile?');
