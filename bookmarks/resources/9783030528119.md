...
> equals $1$. Specifically, for each $j = 1 , 2 , \ldots , n$, we define the
> vector $e_j \in R^n$ by
>
> $e_j = (0 , 0 , \ldots , 0 , 1 , 0 , \ldots , 0)$.
>
> For example, in $R^2$ there are two such vectors: $e1 = (1 , 0)$ and $e2 = (0
> , 1)$. Similarly, in $R^3$ there are three such vectors: $e1 = (1, 0, 0)$,
> $e2 = (0, 1, 0)$, and $e3 = (0, 0, 1)$. In general, in $R^n$ there are $n$ of
> these vectors, $e1 , e2 , \ldots , e_n$.
...
> $3e_1 - 2e_2 + e_3 \in R^3 = 3(1,0,0) - 2(0,1,0) + (0,0,1) = (3,2,1)$
